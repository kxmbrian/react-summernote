...
(function (factory) {
  ...
  var isSupportAmd = "function" === 'function' && __webpack_require__(15);
  ...
  if (agent.hasCodeMirror) {
    if (agent.isSupportAmd) {
      Promise.resolve().then(function() { var __WEBPACK_AMD_REQUIRE_ARRAY__ = [__webpack_require__(5)]; (function (cm) {
        CodeMirror = cm;
